...
<?php
	...
	if (isset($_POST['hantar']))
	{
		...
		$result = mysqli_query($connect, "INSERT INTO pelajar (id_pelajar,nama_pelajar,kelas,suhu,tarikh,catatan)"."VALUES('$id_pelajar','$nama_pelajar','$kelas','$suhu','$tarikh','$catatan')");
